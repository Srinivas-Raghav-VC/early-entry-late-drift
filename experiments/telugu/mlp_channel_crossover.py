...
from experiments.hindi.mlp_channel_panel import (  # noqa: E402
    _extract_mlp_channel_vector,
    _get_mlp,
)
from experiments.hindi.practical_patch_eval import (  # noqa: E402
    _bootstrap_mean_ci,
    _json_safe,
    _register_channel_add_hook,
)
from experiments.telugu.practical_patch_eval import (  # noqa: E402
    _build_item_setup,
...
def main() -> int:
    ...
    out_root = (
        ...
        else REPO_ROOT / "research" / "results" / "telugu_mlp_channel_crossover_v1" / str(args.model) / str(args.pair) / f"seed{int(args.seed)}" / f"nicl{int(args.n_icl)}"
    )
