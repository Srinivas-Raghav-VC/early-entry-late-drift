...
from experiments.hindi.practical_patch_eval import _bootstrap_mean_ci, _json_safe  # noqa: E402
...
def main() -> int:
    ...
    out_root = (
        ...
        else REPO_ROOT / "research" / "results" / "telugu_continuation_practical_patch_eval_v1" / str(args.model) / str(args.pair) / f"seed{int(args.seed)}" / f"nicl{int(args.n_icl)}"
    )
