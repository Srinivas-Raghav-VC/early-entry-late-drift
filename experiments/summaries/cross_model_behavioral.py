...
RESULTS = ROOT / "research/results/cross_model_behavioral_v1"
...
def main() -> int:
    if not RESULTS.exists():
        print("NOTE: Cross-model raw artifacts not found in this compact archive.")
        print(f"      The pre-computed summary is already at: {OUT_MD.relative_to(ROOT)}")
        print("      Full regeneration requires the complete cross-model result store.")
        return 0
